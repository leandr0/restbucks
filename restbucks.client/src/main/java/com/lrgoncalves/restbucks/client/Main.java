...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        URI serviceUri = processCommandLineArgs(args);
    ...
    private static void happyPathTest(URI serviceUri) throws Exception {
        ...
        URI orderUri = new URI(serviceUri.toString()+"order");
        OrderRepresentation orderRepresentation = client.resource(orderUri).accept(RESTBUCKS_MEDIA_TYPE).type(RESTBUCKS_MEDIA_TYPE).post(OrderRepresentation.class, new ClientOrder(order));
        ...
        order = order().withRandomItems().build();
        Link updateLink = new Link("update", new RestbucksUri(serviceUri.toString()+"order"));//orderRepresentation.getUpdateLink();
